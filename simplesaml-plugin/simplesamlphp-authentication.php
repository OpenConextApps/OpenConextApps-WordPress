    ...
    function authenticate(&$username, &$password) {
      ...
      if ($user) {
        ...
        if ($simplesaml_authentication_opt['new_user'] == 1) {
          ...
          if($attributes['urn:mace:dir:attribute-def:givenName'])
            $user_info['first_name'] = $attributes['urn:mace:dir:attribute-def:givenName'][0];
          if($attributes['urn:mace:dir:attribute-def:sn'])
            $user_info['last_name'] = $attributes['urn:mace:dir:attribute-def:sn'][0];
