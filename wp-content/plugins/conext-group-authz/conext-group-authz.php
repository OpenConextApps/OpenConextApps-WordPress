...
class Conext_Authorization {
  ...
  static function apply_authorization($username, WP_User $oWPUser) {
  	...
  	/* start of workaround: use 'NameID::unspecified' as username, which is 
  	 * returned by EngineBlock as attribute 
  	 *     'urn:oid:1.3.6.1.4.1.1076.20.40.40.1'
  	 */
  	global $as;
  	$attrs = $as->getAttributes();
  	$alt_username = $attrs['urn:oid:1.3.6.1.4.1.1076.20.40.40.1'][0]; 
  	...
  	// $username = 'urn:collab:person:test.surfguest.nl:mdobrinic';
  	//print('For development purposes: changing username to become '.$username);
